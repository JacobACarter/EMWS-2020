    ...
    def determineField(self, omega, k1, k2, num_points=400):
            ...
            for layer in range(num_layers):
                ...
                for i in range(num_points):
                    ...
                    e3.append(((e[2][0] * fieldVec[0::4].real + e[2][1] * fieldVec[1::4].real - kap2 * fieldVec[2::4].real + kap1 * fieldVec[3::4].real) / (e[2][2]))[0])
                    h3.append(((kap2 * fieldVec[0::4].real - kap1 * fieldVec[1::4].real + u[2][0] * fieldVec[2::4].real + u[2][1] * fieldVec[3::4].real) / (u[2][2]))[0])
                Etemp = []
                Htemp = []
                ...
                for i in range(len(DField)):
                    Dx.append(DField[i][0])
                    Dy.append(DField[i][1])
                    Dz.append(DField[i][2])
                    Bx.append(BField[i][0])
                    By.append(BField[i][1])
                    Bz.append(BField[i][2])
            field = {
                'z': z_arr,
                'Ex': Ex,
                'Ey': Ey,
